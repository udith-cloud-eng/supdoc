...
<body class="body" id="body" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"
    ...
    $statusMessage = [
        ...
        'Enable' => 'We have received your request to cancel your order placed through our cloud platform. Your cancellation request is being processed promptly. If you have any further questions or concerns regarding your order cancellation or any other matter, please feel free to contact our customer support team on our Cloud Platform. We are always here to assist you.',
        'Disable' => 'We are pleased to inform you that your previously canceled order at Vexma Technologies has been successfully reactivated and is now live again on our cloud platform. Your order is now back in progress, and any services or products associated with it will resume accordingly.',
    ];
@endphp
                                                                @if(array_key_exists($data['status'], $statusMessage))
                                                                <tr>
                                                                    <td style="padding: 20px; background-color: #DEF5FD; font-size: 16px; line-height: 1.6; text-align: left;">
                                                                        ...
                                                                        <p style="font-weight:400;color:black;">{{ $statusMessage[$data['status']] }}</p>
                                                                        @if($data['status'] == 'Enable')
                                                                            <p style="font-weight:400;color:black;"><b>Cancel Reason: {{ $data['cancel_reason'] }}</p>
                                                                        @endif
