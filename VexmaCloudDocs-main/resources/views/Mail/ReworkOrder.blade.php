                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td style="padding: 20px; background-color: #DEF5FD; font-size: 16px; line-height: 1.6; text-align: left;">
                                                                        ...
                                                                        <p style="font-weight:400;color:black;">Your order status has been updated, we will keep you informed about its current status.</p>
                                                                        <p style="font-weight:700;color:black;"><b>Rework Reason: {{ $data['rework_reason'] }}</p>
