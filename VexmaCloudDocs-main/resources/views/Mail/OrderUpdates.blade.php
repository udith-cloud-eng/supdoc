<head>
    ...
    <![endif]-->
    <!--[if !mso]><!-->
        <link href="https://fonts.googleapis.com/css2?family=Nunito+Sans:opsz,wght@6..12,200;6..12,300;6..12,400;6..12,500;6..12,600;6..12,700&family=Quicksand:wght@300;400;500;600;700&display=swap" rel="stylesheet" type="text/css" data-premailer="ignore">
    <link
...
<body class="body" id="body" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"
                                ...
                                <tr>
                                    <th valign="top" style="mso-line-height-rule: exactly;">
                                                                                                                    ...
                                                                                                                    <p style="margin: 0; font-size: 14px; line-height: 1%; text-align: center;">
                                                                                                                        <span style="font-size: 36px; line-height: 39.6px; font-family: inherit; color: #ffffff;">
                                                                                                                            <strong style="line-height: inherit;">
                                                                                                                                <h1 data-key="1468266_heading" style="text-align:center;font-family: 'Quicksand', sans-serif; font-size: 28px; line-height: 1.5; font-weight: 700; color: #ffffff; text-transform: none; background-color: #DEF5FD00; margin-top: 15%;">
                                                                                                                                    Order Status : {{ $data['data']->order_status->name }}
                                                                                                                                </h1>
                                                                                                                            </strong>
                                                                                                                            <br style="line-height: inherit;">&nbsp;
                                                                                                                            <h2 style="font-family: 'Nunito', sans-serif; color: #ffffff; font-size: 20px; line-height: 1; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; margin-top: 10px;" align="center">
                                        ...
                                        <table class="section_wrapper main" data-id="main" id="section-main"
                                            ...
                                            style="min-width: 100%;" role="presentation" bgcolor="#DEF5FD">
                                            <tbody>
                                                <tr>
                                                    <td class="section_wrapper_th"
                                                        style="mso-line-height-rule: exactly;" bgcolor="#DEF5FD">
    ...
    $statusMessage = [
        ...
        'Order Confirmation' => 'Exciting news! Your journey into cutting-edge manufacturing solutions is underway.',
        'PO Pending' => 'A quick reminder regarding your order. The PO is still pending. To ensure a seamless process and prevent delays, kindly share the PO at your earliest convenience.',
        'PO Received' => 'We are pleased to acknowledge your order, and we are excited to inform you that your journey into cutting-edge manufacturing solutions has begun.',
        'Pre-Audit' => 'The Pre-Audit analysis is now accessible in our Vexma Cloud Application. Your prompt evaluation and approval are crucial to prevent delays in your order delivery.',
        'Design Modification' => "We've fine-tuned your product's design to align with 3D printing Design Guidelines. Please review the modified design files in your Digital Inventory. \nYour prompt feedback on the modifications is crucial. We await your approval to proceed with production. Prioritise this to avoid any potential delays.",
        '3D Printing' => 'Your order status has been updated, we will keep you informed about its current status.',
        'Post Processing' => 'Your order status has been updated, we will keep you informed about its current status.',
        'Paint' => 'Your order status has been updated, we will keep you informed about its current status.',
        'Final Audit' => "We are pleased to inform you that your manufacturing requirements have been met with the utmost precision. \nPlease review the finished parts and check our audit report for your satisfaction in our Vexma Cloud App. \nTo proceed with the next step shipment, your visual inspection and approval of the audit report are crucial.",
        'Ready To Ship' => "Your Order is ready to ship from our manufacturing hub. Once the part is shipped, we'll promptly share the tracking details, including the docket number.",
        'Shipped' => 'We are thrilled to inform you that your order has been successfully shipped and is on its way to its destination. We appreciate your trust in Vexma and hope you enjoy your order.',
        'Hold' => 'We have received your request to place the order on hold, and we are promptly addressing it. We understand the importance of this decision and assure you that your order will remain in our system until further notice. Should you have any specific instructions or a timeline for releasing the hold on your order, please do not hesitate to inform us. Our team is committed to accommodating your requirements and ensuring a seamless experience for you.'
    ];
@endphp
                                                                @if(array_key_exists($data['data']->order_status->name, $statusMessage))
                                                                <tr>
                                                                    <td style="padding: 20px; background-color: #DEF5FD; font-size: 16px; line-height: 1.6; text-align: left;">
                                                                        <p style="font-weight:400;color:black;">Greetings {{ $data['data']->client->name }},</p>
                                                                        <p style="font-weight:400;color:black;">{{ $statusMessage[$data['data']->order_status->name] }}</p>
                                                                        <p style="font-weight:700;color:black;"><b>Order Status: {{ $data['data']->order_status->name }}</p>
                                                                        @if($data['data']->order_status->name != 'Shipped')
                                                                        <p style="font-weight:700;color:black;"><b>Expected Dispatch Date: {{ $data['data']->expected_delivery_date }}</p>
                                                                        @endif
                                                                        @if($data['data']->order_status->name == 'Hold')
                                                                            <p style="font-weight:400;color:black;"><b>Reason: {{ $data['reason']}}</p>
                                                                        @endif
                                                                        <p style="font-weight:400;color:black;">Feel free to reach out with any questions or concerns. Expect further updates at every checkpoint, and we'll notify you if additional approvals are needed.</p>
                                                                        <p style="font-weight:400;color:black;">Best regards, <br>Team Vexma</p>
                                                                    </td>
                                                                </tr>
                                                            @endif
...
<a href="https://cloud.vexmatech.com/"
                                                                                            ...
                                                                                            class="template-btn"
                                                                                            style="color: #ffffff; background-color: #3A75FF; text-decoration: none !important; text-underline: none; text-transform: none; margin: 6px; display: block; width: auto">View Account</a>
</div>
...
<a href="https://zcal.co/i/9UE_HSmp"
                                                                                            ...
                                                                                            data-key="section_shop_block1"
                                                                                            class="template-btn"
                                                                                            style="color: #ffffff; background-color: #3A75FF; text-decoration: none !important; text-underline: none; text-transform: none; margin: 6px; display: block; width: auto">Schedule Meeting</a>
</div>
    </div>
...
<a href="https://forms.gle/iHKb2pXmtsoWiaS68" target="_blank"
                                                                                            data-key="section_shop_block1"
                                                                                            class="template-btn"
                                                                                            style="color: #ffffff; background-color: #3A75FF; text-decoration: none !important; text-underline: none; text-transform: none; margin: 3px;">We Value Feedback</a>
</div>
    </div>
</div>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <th class="column_shop_block1 "
                                                                                        width="100%"
                                                                                        style="mso-line-height-rule: exactly; font-family: 'Quicksand', sans-serif; font-size: 14px; line-height: 24px; font-weight: 400; color: #0b14609c; text-transform: none; padding-bottom: 13px; padding-top: 26px;"
                                                                                        align="center"
                                                                                        bgcolor="#DEF5FD">
