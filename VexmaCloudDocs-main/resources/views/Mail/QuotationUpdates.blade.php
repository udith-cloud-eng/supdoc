                                                                                                                    ...
                                                                                                                    <p style="margin: 0; font-size: 14px; line-height: 1%; text-align: center;">
                                                                                                                        <span style="font-size: 36px; line-height: 39.6px; font-family: inherit; color: #ffffff;">
                                                                                                                            <strong style="line-height: inherit;">
                                                                                                                                ...
                                                                                                                                Quotation ID : {{ $data['data']->quotation_no }}
                                                                                                                                </h1>
                                                                                                                            </strong>
                                                                ...
                                                                <!-- BEGIN SECTION: Introduction -->
                                                                 ...
                                                                 <tr>
                                                                    <td style="padding: 20px; background-color: #DEF5FD; font-size: 16px; line-height: 1.6; text-align: left;">
                                                                        <p style="font-weight:400;color:black;">Greetings {{ $data['data']->employee->name }},</p>
                                                                        @if($data['data']->modifyquote_reason != 'confirm')
                                                                        <p style="font-weight:400;color:black;"><b>Quote Modification Request from {{ $data['data']->client->name }} <br>Reason: {{ $data['data']->modifyquote_reason }}</p>
                                                                         @endif
                                                                         @if($data['data']->modifyquote_reason == 'confirm')
                                                                        <p style="font-weight:400;color:black;"><b>Quotation approved by {{ $data['data']->client->name }}. Please proceed to Order Confirmation.</p>
                                                                         @endif
                                                    ...
                                                    <table border="0" width="100%"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                style="mso-line-height-rule: exactly; font-family: 'Quicksand', sans-serif; font-size: 14px; line-height: 24px; font-weight: 400; color: #0b14609c; text-transform: none; padding: 8px;"
                                                                align="center"
                                                                bgcolor="#DEF5FD">
                                                                    <a href="https://cloud.vexmatech.com/"
                                                                        ...
                                                                        class="template-btn"
                                                                        style="color: #ffffff; text-decoration: none !important; text-underline: none; text-transform: none; margin: 6px; display: block; width: auto">View Account</a></th>
                                                                        <th class="column_shop_block1 "
                                                                        style="mso-line-height-rule: exactly; font-family: 'Quicksand', sans-serif; font-size: 14px; line-height: 24px; font-weight: 400; color: #0b14609c; text-transform: none; padding: 8px;"
                                                                        align="center"
                                                                        bgcolor="#DEF5FD">
                                                                        ...
                                                                        data-key="section_shop_block1"
                                                                        class="template-btn"
                                                                        style="color: #ffffff; text-decoration: none !important; text-underline: none; text-transform: none; margin: 6px; display: block; width: auto">Schedule Meeting</a></th>
                                                            </tr>
                                                            <!-- Store Website : END -->
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table border="0" width="100%"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <th class="column_shop_block1 "
                                                                    width="100%"
                                                                    style="mso-line-height-rule: exactly; font-family: 'Quicksand', sans-serif; font-size: 12px; line-height: 24px; font-weight: 400; color: #0b14609c; text-transform: none; padding-bottom: 24px; padding-top: 12px;"
                                                                    align="center"
                                                                    bgcolor="#DEF5FD">
